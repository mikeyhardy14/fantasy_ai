...
def map_league_details(raw: dict[str, Any], fallback_week: int | None = None) -> LeagueDetails:
    ...
    return LeagueDetails(
        ...
        roster_settings={
            ...
            "reserve_allow_out": bool(int(settings.get("reserve_allow_out") or 0)),
            "reserve_allow_doubtful": bool(int(settings.get("reserve_allow_doubtful") or 0)),
            "reserve_allow_sus": bool(int(settings.get("reserve_allow_sus") or 0)),
            "reserve_allow_cov": bool(int(settings.get("reserve_allow_cov") or 0)),
            "reserve_allow_na": bool(int(settings.get("reserve_allow_na") or 0)),
            "reserve_allow_dnr": bool(int(settings.get("reserve_allow_dnr") or 0)),
